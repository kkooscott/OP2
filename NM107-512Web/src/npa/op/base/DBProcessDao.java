...
public class DBProcessDao {
     ...
     */
    protected CachedRowSet pexecuteQueryRowSet(String sql, Object[] objs) {
    ...
    /**
     * 提供與executeQuery相同的功能,只是換成prepareStatement FOR E82DB
     * @param sql
     * @param objs 目前實作String;Integer;Timestamp
     * @return
     */
    protected ArrayList<HashMap> E8pexecuteQuery(String sql, Object[] objs) {
	return DBUtil.getInstance().E8pexecuteQuery(sql, objs);
    }
    
    /**
     * 提供與executeQuery相同的功能,只是換成prepareStatement FOR SSDB
     * @param sql
     * @param objs 目前實作String;Integer;Timestamp
     * @return
     */
    protected ArrayList<HashMap> SSpexecuteQuery(String sql, Object[] objs) {
	return DBUtil.getInstance().SSpexecuteQuery(sql, objs);
    }
