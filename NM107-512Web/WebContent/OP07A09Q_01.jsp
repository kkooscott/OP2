														...
														<td valign="top">
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td class="labelField">設定要列印之已受理未公告超過天/月數：</td>
                                                                                                                                    <td class="dataField" width="40%">
                                                                                                                                        <input type="text"
                                                                                                                                            class="form-control" size="5"
                                                                                                                                            id="OP_AC_NO_AN" />
                                                                                                                                        <select class="form-control" id="OP_AC_NO_AN_CMB">
                                                                                                                                            <option value="" ></option>
                                                                                                                                            <option value="1">天</option>
                                                                                                                                            <option value="2">月</option>
                                                                                                                                        </select>
                                                                                                                                    </td>
                                                                                                                                    <td class="labelField">設定要列印之公告期滿未結案超過天/月數：</td>
                                                                                                                                    <td class="dataField" width="40%">
                                                                                                                                        <input type="text"
                                                                                                                                            class="form-control" size="5"
                                                                                                                                            id="OP_AN_NO_CLOSE" />
                                                                                                                                        <select class="form-control" id="OP_AN_NO_CLOSE_CMB">
                                                                                                                                            <option value="" ></option>
                                                                                                                                            <option value="1">天</option>
                                                                                                                                            <option value="2">月</option>
                                                                                                                                        </select>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A09Q_01.js"></script>
