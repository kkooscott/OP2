															...
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td nowrap="nowrap" class="dataField">
																		...
																		id="OP_PU_DATE_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_PU_DATE_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_PU_DATE_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_PU_DATE_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_PU_DATE_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_PU_DATE_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																	...
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_AC_DATE_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_AC_DATE_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_AC_DATE_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_AC_DATE_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_AC_DATE_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_AC_DATE_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" />
																	</td>
																</tr>
                                                                                                                                <tr>
                                                                                                                                        <td class="labelField">結案日期起迄：</td>
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_FS_DATE_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_FS_DATE_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_FS_DATE_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_FS_DATE_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_FS_DATE_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_FS_DATE_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" />
																	</td>
                                                                                                                                </tr>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A08Q_01.js"></script>
