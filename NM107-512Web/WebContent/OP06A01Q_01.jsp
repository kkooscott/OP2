...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-full-width">
                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dataField" width="40%">
                                                                            <input type="text" class="form-control" size="30" maxlength="30"
                                                                                   id="OP_SEARCH_AC_STAFF_NM" />
                                                                        </td>
                                                                        <td class="labelField" width="10%">收據編號：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <input type="text" class="form-control" size="30" maxlength="17"
                                                                                   id="OP_SEARCH_AC_RCNO" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="labelField" width="10%">拾得人姓名：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <input type="text" class="form-control" size="30" maxlength="30"
                                                                                   id="OP_SEARCH_PUPO_NAME" />
                                                                        </td>
                                                                        <td class="labelField" width="10%">性別：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control" id="OP_SEARCH_PUPO_GENDER">
                                                                    ...
                                                                    <tr>
                                                                        <td class="labelField" width="10%">身分證/其他證號：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control" id="OP_SEARCH_PUPO_IDN_TP">
                                                                                <option value="">請選擇...</option>
                                                                            ...
                                                                            <input type="text"
                                                                                   ...
                                                                                   id="OP_SEARCH_PUPO_IDN" />
                                                                        </td>
                                                                        <td class="labelField" width="10%">物品名稱：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <input type="text" class="form-control" size="30" maxlength="40"
                                                                                   id="OP_SEARCH_PUOJ_NM" />
                                                                            <label id = "label1" class="normal-label"><font color="red">(提供最近一年受理日期全文索引。)</font></label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control" id="OP_SEARCH_FS_REC_CD"
                                                                                    data-width="180px" data-size="8">
                                                                            </select>
                                                                        </td>
                                                                        <td class="labelField" width="10%">拾得物總價值：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control" data-width="auto" id="OP_SEARCH_PU_YN_OV500">
                                                                                <option value="">請選擇...</option>
                                                                                <option value="0">伍佰元(含)以下</option>
                                                                                <option value="1">超過伍佰元</option>
                                                                            </select>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                    ...
                                    <div class="tabbable-custom " id="divModalContent">                                                                        
                                        ...
                                        <ul class="nav nav-tabs ">
                                            <li class="active" id="tabInfomation1"><a href="#tab_4_1"
                                                                                      data-toggle="tab"> 拾得物受理基本資料 </a></li>
                                            ...
                                            <li id="tabInfomation9"><a href="#tab_4_9"
                                                                       data-toggle="tab"> 結案資料 </a></li>
                                            <li id="tabInfomation10"><a href="#tab_4_10"
                                                                        data-toggle="tab"> 結案資料 </a></li>
                                            <li id="tabInfomation11"><a href="#tab_4_11"
        ...
        <script src="assets/js/OP06A01Q_01.js"></script>
