...
<body class="page-header-fixed page-full-width">
															...
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td class="labelField" width="10%">
                                                                                                                                            <img src="assets/img/required.png" />查詢日期起迄：
                                                                                                                                        </td>
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_QUERY_DT_TM_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_QUERY_DT_TM_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_QUERY_DT_TM_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_QUERY_DT_TM_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_QUERY_DT_TM_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_QUERY_DT_TM_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
	...
	<script src="assets/js/OP09A02Q_01.js"></script>
