																	...
																	<td nowrap="nowrap" class="dataField">
																		...
																		alt="選擇日期" style="cursor: pointer" />
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                        ...
                                                                                                                                        <td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_SEARCH_FS_DATE_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_SEARCH_FS_DATE_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_SEARCH_FS_DATE_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_SEARCH_FS_DATE_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_SEARCH_FS_DATE_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_SEARCH_FS_DATE_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" />
																	</td>
                                                                                                                                    <td class="labelField">列印遺失人：</td>
                                                                                                                                    <td class="dataField" colspan="3">
                                                                                                                                        <input type="checkbox" id="printPUCP_NM_YN" name="printPUCP_NM_YN" value="Y"/>
                                                                                                                                        (含
                                                                                                                                        <input type="checkbox" id="printPUCP_IDN_YN" name="printPUCP_IDN_YN" value="Y"/>證號
                                                                                                                                        <input type="checkbox" id="printPUCP_ADDR_YN" name="printPUCP_ADDR_YN" value="Y"/>地址
                                                                                                                                        <input type="checkbox" id="printPUCP_TEL_YN" name="printPUCP_TEL_YN" value="Y"/>電話
                                                                                                                                        )
                                                                                                                                    </td>
                                                                                                                                </tr>    
																<tr>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A11Q_01.js"></script>
