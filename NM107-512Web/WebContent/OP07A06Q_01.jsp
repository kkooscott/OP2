													...
													<tr>
														<td valign="top">
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td class="labelField">通知拾得人領回日期起迄：</td>
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_NTC_PUPO_DT_S" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_NTC_PUPO_DT_S',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_NTC_PUPO_DT_S',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_NTC_PUPO_DT_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_NTC_PUPO_DT_E',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_NTC_PUPO_DT_E',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																...
																<tr>																	
																	...
																	<td class="dataField" colspan="3">
                                                                                                                                            <input type="text" class="form-control" size="30" id="OP_AC_RCNO" />
                                                                                                                                        </td>
																</tr>
																<tr>
																	<td colspan="4">
																		<button class="btn green btn-sm" type="button"
																			id="printBtnPDF" name="printBtnPDF">
																			<i class="fa fa-print"></i>&nbsp;列印PDF
																		</button>&nbsp;
																	</td>
																</tr>
															</table>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A06Q_01.js"></script>
