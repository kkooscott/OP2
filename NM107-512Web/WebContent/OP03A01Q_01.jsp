...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-full-width">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li><a href="#">拾得遺失物招領</a> <i class="fa fa-angle-right"></i>
                                </li>
                                <li><a href="#">拾得物招領資料維護</a>
                                </li>
                                                            ...
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="labelField" width="10%">是否公告：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control"
                                                                                    data-width="auto" id="OP_SEARCH_YN_AN">
                                                                                <option value="0">未公告</option>
                                                                                <option value="1">已發內部公告</option>
                                                                                <option value="2">已發網路公告</option>
                                                                            </select>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="labelField" width="10%">招領發文文號：</td>
                                                                        <td class="dataField" colspan="3">
                                                                            <input type="text" class="form-control" size="20" maxlength="20" id="OP_SEARCH_DOC_WD"/>字第
                                                                            <input type="text" class="form-control" size="11" maxlength="11" id="OP_SEARCH_DOC_NO"/>號
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4">
        ...
        <script src="assets/js/OP03A01Q_01.js"></script>
