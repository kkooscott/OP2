    ...
    $('#printBtn').click(function () {
        ...
        if (bool){
            downloadReport("ReportServlet", {
                ajaxAction: 'OP07A04Q.xls',
                reportName: 'oP07A04Q.xlsx',
                newReportName: '拾得物公告招領清冊列印.xlsx',
                ...
                OP_AC_STAFF_NM : $('input[name=showStaff]:checked').val(),
                includeYN:$('input[name=includeYN]:checked').val(),
                OP_CERT_YN : $('input[name=suspectType]:checked').val(),
                lockType : 'A'
            });
        }
    });	
