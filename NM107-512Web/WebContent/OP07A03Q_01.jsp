													...
													<tr>
														<td valign="top">
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td class="labelField">公告日期起迄：</td>
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
																		id="OP_AN_DATE_BEG" value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_AN_DATE_BEG',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_AN_DATE_BEG',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
																		alt="選擇日期" style="cursor: pointer" /> ～<input
																		type="text" class="form-control" id="OP_AN_DATE_END"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_AN_DATE_END',dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({el:'OP_AN_DATE_END',dateFmt:'yyy/MM/dd'})"
																		src="assets/img/calendar.gif" align="absmiddle"
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A03Q_01.js"></script>
