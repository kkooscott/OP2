															...
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td nowrap="nowrap" class="dataField">
																		...
																		<img
																		onclick="WdatePicker({el:'OP_SEARCH_PU_DATE_S',dateFmt:'yyy/MM/dd'})"
																		...
																		type="text" class="form-control" id="OP_SEARCH_PU_DATE_E"
																		value=""
																		onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
																		onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
																		<img
																		onclick="WdatePicker({el:'OP_SEARCH_PU_DATE_E',dateFmt:'yyy/MM/dd'})"
																	...
																	<td nowrap="nowrap" class="dataField">
																		...
																		alt="選擇日期" style="cursor: pointer" />
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td class="labelField" width="10%">受理員警：</td>
                                                                                                                                    <td class="dataField" width="40%">
                                                                                                                                        <input type="checkbox" id="showStaff" name="showStaff" value="Y"/>顯示姓名
                                                                                                                                    </td>
                                                                                                                                    <td class="labelField" width="10%">證件：</td>
                                                                                                                                    <td class="dataField" width="40%">
                                                                                                                                        <label class="radio-inline"> </label> 
                                                                                                                                            <input type="radio"
                                                                                                                                                    id="OP_CERT_Y" name="suspectType"
                                                                                                                                                    value="1"
                                                                                                                                                    onclick="changePattern('yesPattern','')" checked />有
                                                                                                                                        
                                                                                                                                        <label class="radio-inline"> </label>
                                                                                                                                            <input type="radio"
                                                                                                                                                    id="OP_CERT_N" name="suspectType"
                                                                                                                                                    value="0"
                                                                                                                                                    onclick="changePattern('','yesPattern')"/>無
                                                                                                                                        
                                                                                                                                        <label class="radio-inline"> </label>
                                                                                                                                            <input type="radio"
                                                                                                                                                    id="OP_CERT" name="suspectType"
                                                                                                                                                    value=""
                                                                                                                                                    onclick="changePattern('','yesPattern')"/>全部
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A04Q_01.js"></script>
