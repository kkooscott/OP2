			...
			<div class="page-content">
				...
				<div class="row">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li><a href="#">未經認領及領回拾得物移交地方自治團體清冊</a>
                                                        </li>
														...
														<td valign="top">
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td nowrap="nowrap" class="dataField">
																		<input type="text" class="form-control"
                                                                                                                                                    id="OP_SEARCH_NTC_PUPO_DT_S" value=""
                                                                                                                                                    onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
                                                                                                                                                <img onclick="WdatePicker({el:'OP_SEARCH_NTC_PUPO_DT_S',dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    onfocus="WdatePicker({el:'OP_SEARCH_NTC_PUPO_DT_S',dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    src="assets/img/calendar.gif" align="absmiddle"
                                                                                                                                                    alt="選擇日期" style="cursor: pointer" /> ～
                                                                                                                                                <input type="text" class="form-control" id="OP_SEARCH_NTC_PUPO_DT_E"
                                                                                                                                                    value=""
                                                                                                                                                    onclick="WdatePicker({dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    onfocus="WdatePicker({dateFmt:'yyy/MM/dd'})">
                                                                                                                                                <img onclick="WdatePicker({el:'OP_SEARCH_NTC_PUPO_DT_E',dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    onfocus="WdatePicker({el:'OP_SEARCH_NTC_PUPO_DT_E',dateFmt:'yyy/MM/dd'})"
                                                                                                                                                    src="assets/img/calendar.gif" align="absmiddle"
                                                                                                                                                    alt="選擇日期" style="cursor: pointer" />
																	</td>
                                                                                                                                        <td class="labelField">拾得物種類：</td>
                                                                                                                                        <td class="dataField">
                                                                                                                                            <select class="form-control" data-width="auto" id="OP_SEARCH_TYPE_CD">
                                                                                                                                                <option value=""></option>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP07A15Q_01.js"></script>
