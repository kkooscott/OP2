...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-full-width">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li><a href="#">拾得人領回公告</a> <i class="fa fa-angle-right"></i>
                                </li>
                                <li><a href="#">拾得人領回公告資料維護</a>
                                </li>
                                                            ...
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="labelField" width="10%">通知領回紀錄：</td>
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control"
                                                                                    data-width="auto" id="OP_SEARCH_NTC_GB_REC">
                                                                    ...
                                                                    <tr>
                                                                        <td class="labelField" width="10%">領回發文文號：</td>
                                                                        <td class="dataField" colspan="3">
                                                                            <input type="text" class="form-control" size="20" maxlength="20" id="OP_SEARCH_PUPO_DOC_WD"/>字第
                                                                            <input type="text" class="form-control" size="11" maxlength="11" id="OP_SEARCH_PUPO_DOC_NO"/>號
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4">
                                    ...
                                    <div class="tabbable-custom " id="divModalContent">                                                                        
                                        ...
                                        <ul class="nav nav-tabs ">
                                            ...
                                            <li id="tabInfomation5"><a href="#tab_4_5"
                                                                       data-toggle="tab"> 招領期滿處理資料 </a></li>
                                            <li class="active" id="tabInfomation6"><a href="#tab_4_6"
                                                                                      data-toggle="tab"> 拾得人領回公告資料 </a></li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab_4_6">
        ...
        <script src="assets/js/OP04A01Q_01.js"></script>
