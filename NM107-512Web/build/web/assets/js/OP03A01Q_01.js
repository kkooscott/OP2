...
//                $('#OP_AN_unitLevel4').val(strPermissionData['UNITLEVEL3']);
            ...
            getAnn1GridList($('#IPUBASIC_OP_SEQ_NO').val(), "OP03A01Q");
        } else {
            clearAnn1Data();
    ...
    $('#printBtn').click(function () {
        if ($('#jqg_gridList_3_1').prop('checked')) {
            downloadReport("ReportServlet", {
                ajaxAction: 'OP03A01Q.doc',
                reportName: 'oP03A01Q.doc',
                newReportName: '拾得物公告招領公告單.doc',
        ...
        if ($('#jqg_gridList_3_2').prop('checked')) {
            downloadReport("ReportServlet", {
                ajaxAction: 'OP03A02Q.xls',
                reportName: 'oP03A02Q.xlsx',
                newReportName: '拾得物公告招領清冊.xlsx',
                OP_BASIC_SEQ_NO: $('#IPUBASIC_OP_SEQ_NO').val(),
                lockType: 'A'
            });
        }
