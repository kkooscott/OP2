...
$(document).ready(function () {
    ...
    $('#menu04span').addClass("selected");
    $('#menu0402').addClass("active");
    init();
});
...
function registButton() {
    ...
    $('#tabInfomation5').click(function () {
        ...
        if (checkYNDetail == 'Y') {
            $('#tab_4_7_main').show();
            $('#tab_4_7_alert').hide();
            showIAnDlGridList($('#IPUBASIC_OP_SEQ_NO').val()); //顯示畫面資料
        } else {
            $('#saveIAnDlBtn').hide();
            $('#tab_4_7_main').hide();
            $('#tab_4_7_alert').show();
    ...
    $('#printBtn').click(function () {
        if ($('#jqg_gridList_3_1').prop('checked')) {
            downloadReport("ReportServlet", {
                ajaxAction: 'OP04A01Q.doc',
                reportName: 'oP04A01Q.doc',
                newReportName: '拾得物送交地方自治團體函.doc',
        ...
        if ($('#jqg_gridList_3_2').prop('checked')) {
            downloadReport("ReportServlet", {
                ajaxAction: 'OP04A02Q.xls',
                reportName: 'oP04A02Q.xlsx',
                newReportName: '拾得人逾期未領取拾得物清冊.xlsx',
                OP_BASIC_SEQ_NO: $('#IPUBASIC_OP_SEQ_NO').val(),
                lockType: 'A'
            });
        }
    ...
    if (bool) {
        ...
        $(gridId).jqGrid({
            ...
            postData: {
                ...
                OP_PUPO_DOC_WD: $("#OP_SEARCH_PUPO_DOC_WD").val(),
                OP_PUPO_DOC_NO: $("#OP_SEARCH_PUPO_DOC_NO").val(),
                OP_PU_YN_OV500: '1',
                OP_DEL_FLAG: '0',
                ACTION_TYPE: 'OP04A02Q_01',
...
function showGridList3() {
    ...
    $(gridId).jqGrid('addRowData', 1, {
        FILE_NAME: '拾得物送交地方自治團體函'
    });
    $(gridId).jqGrid('addRowData', 2, {
        FILE_NAME: '拾得人逾期未領取拾得物清冊'
    });
