					...
					<div class="tab-content">
						<div class="tab-pane active" id="tabMain">
							<div class="row">
								...
								<div class="row">
                                                                        <div class="col-md-12">
                                                                            &nbsp;<label class="labelField" width="10%">刪除原因：</label>
                                                                            <input type="text" class="form-control" size="50" maxlength="100" id="batchdPuDeleteReason"/>
...
<script src="assets/js/jquery.blockUI.js"></script>
	<script src="assets/js/OP02A03Q_01.js"></script>
