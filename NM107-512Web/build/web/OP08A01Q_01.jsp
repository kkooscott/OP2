...
<body class="page-header-fixed page-full-width">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<form id="form1" onsubmit="return false;">
                                        ...
                                        <input type="hidden" id="IPUBASIC_OP_DEL_FLAG" name="IPUBASIC.OP_DEL_FLAG" value="">
																...
																<tr>
																	...
																	<td nowrap="nowrap" class="dataField">
																		...
																		alt="選擇日期" style="cursor: pointer" />
                                                                                                                                ...
                                                                                                                                <tr>
																	<td class="labelField">物品屬性：</td>
																	<td class="dataField" width="40%">
                                                                                                                                            <select class="form-control" id="OP_SEARCH_PUOJ_ATTR_CD"
                                                                                                                                                    data-width="180px" data-size="8">
                                                                                                                                            </select>
                                                                                                                                        </td>
                                                                                                                                        <td class="labelField">刪除案件：</td>
																	<td class="dataField" width="40%">
                                                                                                                                            <select class="form-control"
																		data-width="auto" id="OP_SEARCH_DEL_FLAG">
							...
							<div class="modal-body">
								<div class="tabbable-custom " id="divModalContent">
                                                                    <div style="float: right">
                                                                        &nbsp;
                                                                            <label                class="labelField" width="10%" id="puDeleteLabel" >刪除原因：</label>
                                                                            <input  type="text"   class="form-control" size="30" id="puDeleteReason"/>
                                                                            <button type="button" class="btn red-intense btn-sm" id="puDeleteBtn">
                                                                                <i class="fa fa-times"></i>&nbsp;刪除案件
                                                                            </button>
                                                                        <button class="btn green btn-sm" type="button" id ="updateBasicYnOv500">
										<i class="fa fa-backward"></i>&nbsp;此案轉至一般受理
									</button>&nbsp;&nbsp;
	...
	<script src="assets/js/OP08A01Q_01.js"></script>
