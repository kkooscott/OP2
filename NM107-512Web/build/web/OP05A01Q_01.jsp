...
<html lang="en" class="no-js">
    ...
    <body class="page-header-fixed page-full-width">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li><a href="#">結案資料</a> <i class="fa fa-angle-right"></i>
                                </li>
                    ...
                    <form id="form1" onsubmit="return false;">
                        <input type="hidden" id="IPUBASIC_OP_PU_YN_OV500" name="IPUBASIC.OP_PU_YN_OV500" value="1">
                        ...
                        <input type="hidden" id="actionAnn1Type" name="actionAnn1Type" value="">
                        <input type="hidden" id="actionAnDlType" name="actionAnDlType" value="">
                        <input type="hidden" id="actionPuanDlType" name="actionPuanDlType" value="">
                        <input type="hidden" id="actionFnshType" name="actionPuanDlType" value="">
                        ...
                        <input type="hidden" id="IANNOUNCE_OP_SEQ_NO" name="IANNOUNCE.OP_SEQ_NO" value="">
                        <input type="hidden" id="IANNOUNCE_OP_SEQ_NO2" name="IANNOUNCE2.OP_SEQ_NO2" value="">
                        <input type="hidden" id="IANDL_OP_SEQ_NO" name="IANDL.OP_SEQ_NO" value="">
                        <input type="hidden" id="IPUANDL_OP_SEQ_NO" name="IPUANDL.OP_SEQ_NO" value="">
                        <input type="hidden" id="IFNSH_OP_SEQ_NO" name="IPUANDL.OP_SEQ_NO" value="">
                        ...
                        <input type="hidden" id="OP_UPL_FILE_NAME3" value="" >
                        <input type="hidden" id="IPHOTO_OP_SEQ_NO3" value="" >
                        <input type="hidden" id="IPHOTO_OP_FILE_PATH3" value="" >
                        <input type="hidden" id="IPHOTO_DETELE3" value="" >
                        <input type="hidden" id="OP_UPL_FILE_NAME4" value="" >
                        <input type="hidden" id="IPHOTO_OP_SEQ_NO4" value="" >
                        <input type="hidden" id="IPHOTO_OP_FILE_PATH4" value="" >
                        <input type="hidden" id="IPHOTO_DETELE4" value="" >
                        <input type="hidden" id="OP_YN_GET_NO2" name="OP_YN_GET_NO2" value="">
                        <input type="hidden" id="OP_YN_GET_NO1" name="OP_YN_GET_NO1" value="">
                                                            ...
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dataField" width="40%">
                                                                            <select class="form-control" id="OP_SEARCH_CURSTAT_CD"
                                                                                    data-width="180px" data-size="8">
                                                                            </select>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" class="btn green btn-sm"
                                                    id="batchSaveFinishBtn">
                                                    <i class="fa fa-paper-plane"></i>&nbsp;批次結案
                                            </button>
                                            &nbsp;<label class="labelField" width="10%">結案紀錄：</label>
                                            <select class="form-control"
                                                    data-width="auto" id="batchSaveFinishReason">
                                                <option value=""></option>
                                                <option value="01">遺失人領回</option>
                                                <option value="02">拾得人領回</option>
                                                <option value="03">歸屬地方自治團體</option>
                                                <option value="04">其他</option>
                                            </select>

                                            &nbsp;<label class="labelField" width="10%">結案情形描述：</label>
                                            <input type="text" class="form-control" id="OP_FS_STAT_DESC" size="100" maxlength="1000">
                                        </div>
                                    ...
                                    <div class="tabbable-custom " id="divModalContent">                                                                        
                                        ...
                                        <ul class="nav nav-tabs ">
                                            <li id="tabInfomation1"><a href="#tab_4_1"
                                                                       data-toggle="tab"> 拾得物受理資料 </a></li>
                                            <li id="tabInfomation2"><a href="#tab_4_2"
                                                                       data-toggle="tab"> 拾得物品明細資料 </a></li>
                                            <li id="tabInfomation3"><a href="#tab_4_3"
                                                                       data-toggle="tab"> 民眾認領資料 </a></li>
                                            <li id="tabInfomation4"><a href="#tab_4_4"
                                                                       data-toggle="tab"> 內部公告資料 </a></li>
                                            <li id="tabInfomation5"><a href="#tab_4_5"
                                                                       data-toggle="tab"> 網路公告資料 </a></li>
                                            <li id="tabInfomation6"><a href="#tab_4_6"
                                                                       data-toggle="tab"> 招領期滿處理 </a></li>
                                            <li id="tabInfomation7"><a href="#tab_4_7"
                                                                       data-toggle="tab"> 拾得人領回公告 </a></li>
                                            <li id="tabInfomation8"><a href="#tab_4_8"
                                                                       data-toggle="tab"> 拾得人領回公告期滿 </a></li>
                                            <li class="active" id="tabInfomation9"><a href="#tab_4_9"
                                                                                      data-toggle="tab"> 結案資料 </a></li>
                                            <li id="tabInfomation10"><a href="#tab_4_10"
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab_4_4">
                                                <jsp:include page="OP03B01M_01.jsp" />
                                            </div>
                                            <div class="tab-pane" id="tab_4_5">
                                                <jsp:include page="OP03B02M_01.jsp" />
                                            </div>
                                            <div class="tab-pane" id="tab_4_6">
                                                <jsp:include page="OP03B03M_01.jsp" />
                                            </div>
                                            <div class="tab-pane" id="tab_4_7">
                                                <jsp:include page="OP04B01M_01.jsp" />
                                            </div>
                                            <div class="tab-pane" id="tab_4_8">
                                                <jsp:include page="OP04B02M_01.jsp" />
                                            </div>
                                            <div class="tab-pane active" id="tab_4_9">
                                                <jsp:include page="OP05B01M_01.jsp" />
                                            </div>
        ...
        <script src="assets/js/OP05A01Q_01.js"></script>
